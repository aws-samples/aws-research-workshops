...
# For test only - to speed up the pcluster create process.
aws s3 cp s3://jxudemo/athena_with_hdf5.tar.gz /shared/athena_with_hdf5.tar.gz
cd /shared
tar xzvf athena_with_hdf5.tar.gz
